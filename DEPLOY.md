...
The site is plain static HTML in `public/`. No build step.
...
That's it — `vercel.json` already points at `public/` with asset caching set.

## Updating content
Everything on the page is driven by `public/data.js`:
