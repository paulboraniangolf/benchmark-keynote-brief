...
window.PACKS = [
  { id: "bmp-accuracy", name: "Benchmark Motion — accuracy proof (1:33)", dur: "5.6s", use: "Built for one specific slot. At 1:33 the VO says \"Using the BMP model, we\u2019ve unlocked millimeter precision\" over 3.6s of generic swing B-roll — the biggest technical claim in the film with nothing on screen supporting it. This is the benchmarkmotion.com comparison chart cut to fill that gap: 28.4mm against WHAM 35.9 / MULTI-HMR 41.7 / HMR 2.0 44.5, winning bar carrying the site\u2019s travelling spectrum, closing on \"and 2.7× faster than the next quickest model.\" See BMP-chart-in-context.mp4 for the edit in place.", who: "luigi", tag: "New" },
  { id: "bmp-model", name: "Benchmark Motion — the model", dur: "19.5s", use: "Rebuilt from scratch, far less text. A real point cloud of a real swing — 44 tracked body points from an actual Benchmark Motion capture (7-iron, 120fps), assembling out of noise, then playing P1→P10 while the camera orbits. Beat three drops the field onto an accuracy-vs-speed scatter: Benchmark Motion sits alone in the top-right corner at 28.4mm / 72fps, guide lines drawn back to each axis. Body only — the club is left out on purpose (see note). No version number anywhere.", who: "luigi", tag: "New" },
